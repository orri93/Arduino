...
SET GOS_ARDUINO_DIR=..
CALL:MakeAbsolute GOS_ARDUINO_DIR "%~dp0"

ECHO Arduino root directory is "%GOS_ARDUINO_DIR%"

SET GOS_ARDUINO_LIBRARIES_DIR=%GOS_ARDUINO_DIR%\libraries

FOR /d %%d IN ("%GOS_ARDUINO_LIBRARIES_DIR%\Gos*") DO (
